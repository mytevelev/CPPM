...
public:
        ...
        : Figure(3, "Треугольник")
    {
        ...
        {
            throw BadF( this->name, "Неверно заданы стороны треугольника " );

        }
        if ((angleA <= 0 || angleB <= 0 || angleC <= 0) || (angleA + angleB + angleC) != 180)
        {
            throw BadF(this->name, "Неверно заданы углы треугольника ");
...
int main()
{
    ...
    try 
    {
        ...
        Rhombus rb(78, 77, 77, 77, 60, 120, 60, 120);
    ...
    {
        cout << "Ошибка создания "<< e.get_fname()  << endl;
        cout << e.what() << endl;   /// exception cause 
    }
